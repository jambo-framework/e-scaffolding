...
import com.cgc.tools.codegen.ddl2hbm.JDBCUtil;
...
import com.cgc.tools.codegen.wizards.params.Field;
import com.cgc.tools.codegen.wizards.params.FieldCellModifier;
import com.cgc.tools.codegen.wizards.params.FieldList;
import com.cgc.tools.codegen.wizards.params.FieldSorter;
import com.cgc.tools.codegen.wizards.params.FieldsLabelProvider;
import com.cgc.tools.codegen.wizards.params.IFieldListViewer;
...
public class ParamsObjPage extends WizardPage {
	...
	public ParamsObjPage(String pageName) {
		...
		setDescription("select field name that want to genterate and select condition.");
	}
